...
import {
  css,
  unsafeCSS
} from "./chunk-6BWUGDXF.js";
import {
  formatUnits
} from "./chunk-YBDLTKBV.js";
import {
  __commonJS,
  __toESM
...
var require_dayjs_min = __commonJS({
  "node_modules/dayjs/dayjs.min.js"(exports, module) {
    !function(t2, e2) {
      ...
      "use strict";
      var t2 = 1e3, e2 = 6e4, n2 = 36e5, r2 = "millisecond", i4 = "second", s2 = "minute", u4 = "hour", a2 = "day", o2 = "week", c5 = "month", f7 = "quarter", h5 = "year", d3 = "date", l5 = "Invalid Date", $4 = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y7 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M4 = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t3) {
      ...
      var _2 = function() {
        ...
        return m3.parse = function(t3) {
          ...
          var n3 = this, r3 = !!b4.u(e3) || e3, f8 = b4.p(t3), l6 = function(t4, e4) {
          ...
          }, y8 = this.$W, M6 = this.$M, m4 = this.$D, v5 = "set" + (this.$u ? "UTC" : "");
          switch (f8) {
            case h5:
            ...
            case o2:
              var g2 = this.$locale().weekStart || 0, D4 = (y8 < g2 ? y8 + 7 : y8) - g2;
              return l6(r3 ? m4 - D4 : m4 + (6 - D4), M6);
            case a2:
            case d3:
              return $5(v5 + "Hours", 0);
            case u4:
          ...
          var n3, o3 = b4.p(t3), f8 = "set" + (this.$u ? "UTC" : ""), l6 = (n3 = {}, n3[a2] = f8 + "Date", n3[d3] = f8 + "Date", n3[c5] = f8 + "Month", n3[h5] = f8 + "FullYear", n3[u4] = f8 + "Hours", n3[s2] = f8 + "Minutes", n3[i4] = f8 + "Seconds", n3[r2] = f8 + "Milliseconds", n3)[o3], $5 = o3 === a2 ? this.$D + (e3 - this.$W) : e3;
          if (o3 === c5 || o3 === h5) {
            var y8 = this.clone().set(d3, 1);
            y8.$d[l6]($5), y8.init(), this.$d = y8.set(d3, Math.min(this.$D, y8.daysInMonth())).$d;
          } else l6 && this.$d[l6]($5);
          ...
          if (!this.isValid()) return n3.invalidDate || l5;
          ...
          var $5, y8 = this, M6 = b4.p(d4), m4 = O5(r3), v5 = (m4.utcOffset() - this.utcOffset()) * e2, g2 = this - m4, D4 = function() {
            return b4.m(y8, m4);
          };
          switch (M6) {
            case h5:
      ...
      return O5.prototype = k6, [["$ms", r2], ["$s", i4], ["$m", s2], ["$H", u4], ["$W", a2], ["$M", c5], ["$y", h5], ["$D", d3]].forEach(function(t3) {
        ...
        return t3.$i || (t3(e3, _2, O5), t3.$i = true), O5;
      }, O5.locale = w2, O5.isDayjs = S4, O5.unix = function(t3) {
        return O5(1e3 * t3);
      }, O5.en = D3[g], O5.Ls = D3, O5.p = {}, O5;
    });
  }
});
    ...
    !function(r2, e2) {
      ...
      return function(r2, e2, t2) {
        ...
        t2.en.relativeTime = o2, n2.fromToBase = function(e3, n3, i5, d4, u4) {
          for (var f7, a2, s2, l5 = i5.$locale().relativeTime || o2, h5 = r2.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], m2 = h5.length, c5 = 0; c5 < m2; c5 += 1) {
            var y7 = h5[c5];
            y7.d && (f7 = d4 ? t2(e3).diff(i5, y7.d, true) : i5.diff(e3, y7.d, true));
            var p3 = (r2.rounding || Math.round)(Math.abs(f7));
            if (s2 = f7 > 0, p3 <= y7.r || !y7.r) {
              p3 <= 1 && c5 > 0 && (y7 = h5[c5 - 1]);
              var v4 = l5[y7.l];
              u4 && (p3 = u4("" + p3)), a2 = "string" == typeof v4 ? v4.replace("%d", p3) : v4(p3, n3, y7.l, s2);
              break;
            }
          }
          if (n3) return a2;
...
P.cmp = function(y7) {
  var isneg, x3 = this, xc2 = x3.c, yc2 = (y7 = new x3.constructor(y7)).c, i4 = x3.s, j3 = y7.s, k6 = x3.e, l5 = y7.e;
  if (!xc2[0] || !yc2[0]) return !xc2[0] ? !yc2[0] ? 0 : -j3 : i4;
  if (i4 != j3) return i4;
  isneg = i4 < 0;
  if (k6 != l5) return k6 > l5 ^ isneg ? 1 : -1;
  j3 = (k6 = xc2.length) < (l5 = yc2.length) ? k6 : l5;
  for (i4 = -1; ++i4 < j3; ) {
    if (xc2[i4] != yc2[i4]) return xc2[i4] > yc2[i4] ^ isneg ? 1 : -1;
  }
  return k6 == l5 ? 0 : k6 > l5 ^ isneg ? 1 : -1;
};
P.div = function(y7) {
  ...
  var bl, bt3, n2, cmp, ri3, bz = b4.slice(), ai2 = bl = b4.length, al = a2.length, r2 = a2.slice(0, bl), rl = r2.length, q3 = y7, qc2 = q3.c = [], qi3 = 0, p3 = dp + (q3.e = x3.e - y7.e) + 1;
  q3.s = k6;
  k6 = p3 < 0 ? 0 : p3;
  bz.unshift(0);
  for (; rl++ < bl; ) r2.push(0);
...
P.minus = P.sub = function(y7) {
  var i4, j3, t2, xlty, x3 = this, Big2 = x3.constructor, a2 = x3.s, b4 = (y7 = new Big2(y7)).s;
  if (a2 != b4) {
    y7.s = -b4;
    return x3.plus(y7);
  }
  ...
  if (a2 = xe3 - ye4) {
    ...
    j3 = ((xlty = xc2.length < yc2.length) ? xc2 : yc2).length;
    for (a2 = b4 = 0; b4 < j3; b4++) {
      if (xc2[b4] != yc2[b4]) {
        xlty = xc2[b4] < yc2[b4];
        break;
      }
  ...
  if ((b4 = (j3 = yc2.length) - (i4 = xc2.length)) > 0) for (; b4--; ) xc2[i4++] = 0;
  for (b4 = i4; j3 > a2; ) {
    if (xc2[--j3] < yc2[j3]) {
      for (i4 = j3; i4 && !xc2[--i4]; ) xc2[i4] = 9;
      --xc2[i4];
      xc2[j3] += 10;
    }
    xc2[j3] -= yc2[j3];
...
P.times = P.mul = function(y7) {
  var c5, x3 = this, Big2 = x3.constructor, xc2 = x3.c, yc2 = (y7 = new Big2(y7)).c, a2 = xc2.length, b4 = yc2.length, i4 = x3.e, j3 = y7.e;
  y7.s = x3.s == y7.s ? 1 : -1;
  if (!xc2[0] || !yc2[0]) {
    y7.c = [y7.e = 0];
    return y7;
  ...
  for (c5 = new Array(j3 = a2 + b4); j3--; ) c5[j3] = 0;
  for (i4 = b4; i4--; ) {
    b4 = 0;
    for (j3 = a2 + i4; j3 > i4; ) {
      b4 = c5[j3] + yc2[i4] * xc2[j3 - i4 - 1] + b4;
      c5[j3--] = b4 % 10;
      b4 = b4 / 10 | 0;
    }
    c5[j3] = b4;
...
var NetworkUtil2 = {
  ...
  onSwitchNetwork({ network, ignoreSwitchConfirmation = false }) {
    ...
    const isSupportedForAuthConnector = ConstantsUtil.AUTH_CONNECTOR_SUPPORTED_CHAINS.find((c5) => c5 === network.chainNamespace);
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-HKXG35AK.js");
  const signature_ = (() => {
...
var Id = new Uint8Array(new Array(16).fill(0).map((_2, i4) => i4));
...
function si({ protocol: t2, version: e2, relayUrl: n2, sdkVersion: r2, auth: o2, projectId: i4, useOnCloseEvent: s2, bundleId: c5, packageName: a2 }) {
  const u4 = n2.split("?"), l5 = Mn(t2, e2, r2), f7 = { auth: o2, ua: l5, projectId: i4, useOnCloseEvent: s2 || void 0, packageName: a2 || void 0, bundleId: c5 || void 0 }, h5 = Cn(u4[1] || "", f7);
  return u4[0] + "?" + h5;
}
function gt(t2, e2) {
...
function Zi(t2, e2 = 24) {
  ...
  for (let r2 = 24 - e2; r2 < 24; r2++) {
    ...
    for (let s2 = 0; s2 < 10; s2 += 2) {
      const c5 = (s2 + 8) % 10, a2 = (s2 + 2) % 10, u4 = n2[a2], l5 = n2[a2 + 1], f7 = rr(u4, l5, 1) ^ n2[c5], h5 = or(u4, l5, 1) ^ n2[c5 + 1];
      for (let y7 = 0; y7 < 50; y7 += 10) t2[s2 + y7] ^= f7, t2[s2 + y7 + 1] ^= h5;
    }
    let o2 = t2[2], i4 = t2[3];
    for (let s2 = 0; s2 < 24; s2++) {
      const c5 = er[s2], a2 = rr(o2, i4, c5), u4 = or(o2, i4, c5), l5 = tr[s2];
...
var hr = (t2, e2) => {
  ...
  const i4 = `URI: ${t2.aud || t2.uri}`, s2 = `Version: ${t2.version}`, c5 = `Chain ID: ${lr(e2)}`, a2 = `Nonce: ${t2.nonce}`, u4 = `Issued At: ${t2.iat}`, l5 = t2.exp ? `Expiration Time: ${t2.exp}` : void 0, f7 = t2.nbf ? `Not Before: ${t2.nbf}` : void 0, h5 = t2.requestId ? `Request ID: ${t2.requestId}` : void 0, y7 = t2.resources ? `Resources:${t2.resources.map((p3) => `
- ${p3}`).join("")}` : void 0, E6 = pe(t2.resources);
  if (E6) {
    const p3 = yt(E6);
    o2 = Ke(o2, p3);
  }
  return [n2, r2, "", o2, "", i4, s2, c5, a2, u4, l5, f7, h5, y7].filter((p3) => p3 != null).join(`
`);
};
function mr(t2) {
...
function vr(t2, e2) {
  ...
  return n2.forEach((o2) => {
    ...
    Object.keys(((i4 = t2.att) == null ? void 0 : i4[o2]) || {}).concat(Object.keys(((s2 = e2.att) == null ? void 0 : s2[o2]) || {})).sort((c5, a2) => c5.localeCompare(a2)).forEach((c5) => {
      var a2, u4;
      r2.att[o2] = fr(Me({}, r2.att[o2]), { [c5]: ((a2 = t2.att[o2]) == null ? void 0 : a2[c5]) || ((u4 = e2.att[o2]) == null ? void 0 : u4[c5]) });
    });
  }), r2;
}
function Ke(t2 = "", e2) {
  ...
  Object.keys(e2.att).forEach((c5) => {
    ...
    const l5 = Object.keys(u4).map((f7) => (o2++, `(${o2}) '${f7}': '${u4[f7].join("', '")}' for '${c5}'.`));
...
var Es = (t2, e2) => {
  function n2(r2, ...o2) {
    ...
    return { encrypt(l5, f7) {
      ...
      return a2 = true, tt(l5), c5(s2.encrypt.length, f7), s2.encrypt(l5, f7);
    }, decrypt(l5, f7) {
      if (tt(l5), i4 && l5.length < i4) throw new Error("invalid ciphertext length: smaller than tagLength=" + i4);
      return c5(s2.decrypt.length, f7), s2.decrypt(l5, f7);
    } };
  }
...
function Is(t2, e2, n2, r2, o2, i4, s2, c5) {
  const a2 = o2.length, u4 = new Uint8Array(ge), l5 = mt(u4), f7 = Ye(o2) && Ye(i4), h5 = f7 ? mt(o2) : Tr, y7 = f7 ? mt(i4) : Tr;
  for (let E6 = 0; E6 < a2; s2++) {
    if (t2(e2, n2, r2, l5, s2, c5), s2 >= Ur) throw new Error("arx: counter overflow");
    const p3 = Math.min(ge, a2 - E6);
    if (f7 && p3 === ge) {
      const d3 = E6 / 4;
      if (E6 % 4 !== 0) throw new Error("arx: invalid block position");
      for (let v4 = 0, m2; v4 < Bs; v4++) m2 = d3 + v4, y7[m2] = h5[m2] ^ l5[v4];
      E6 += ge;
      continue;
    }
    for (let d3 = 0, v4; d3 < p3; d3++) v4 = E6 + d3, i4[v4] = o2[v4] ^ u4[d3];
    E6 += p3;
  }
}
function Ns(t2, e2) {
  ...
  return Fe(o2), Fe(s2), Ar(i4), Ar(n2), (c5, a2, u4, l5, f7 = 0) => {
    tt(c5), tt(a2), tt(u4);
    const h5 = u4.length;
    if (l5 === void 0 && (l5 = new Uint8Array(h5)), tt(l5), Fe(f7), f7 < 0 || f7 >= Ur) throw new Error("arx: counter overflow");
    if (l5.length < h5) throw new Error(`arx: output (${l5.length}) is shorter than data (${h5})`);
    const y7 = [];
    let E6 = c5.length, p3, d3;
    if (E6 === 32) y7.push(p3 = Ze(c5)), d3 = As;
    else if (E6 === 16 && n2) p3 = new Uint8Array(32), p3.set(c5), p3.set(c5, 16), d3 = Os, y7.push(p3);
    ...
    const O5 = mt(a2);
    return Is(t2, d3, v4, O5, u4, l5, f7, s2), jt(...y7), l5;
  };
}
...
var Us = class {
  ...
  process(e2, n2, r2 = false) {
    const o2 = r2 ? 0 : 2048, { h: i4, r: s2 } = this, c5 = s2[0], a2 = s2[1], u4 = s2[2], l5 = s2[3], f7 = s2[4], h5 = s2[5], y7 = s2[6], E6 = s2[7], p3 = s2[8], d3 = s2[9], v4 = F(e2, n2 + 0), m2 = F(e2, n2 + 2), O5 = F(e2, n2 + 4), N4 = F(e2, n2 + 6), $4 = F(e2, n2 + 8), B3 = F(e2, n2 + 10), A4 = F(e2, n2 + 12), T2 = F(e2, n2 + 14);
    let S4 = i4[0] + (v4 & 8191), L3 = i4[1] + ((v4 >>> 13 | m2 << 3) & 8191), U4 = i4[2] + ((m2 >>> 10 | O5 << 6) & 8191), _2 = i4[3] + ((O5 >>> 7 | N4 << 9) & 8191), j3 = i4[4] + ((N4 >>> 4 | $4 << 12) & 8191), g = i4[5] + ($4 >>> 1 & 8191), w2 = i4[6] + (($4 >>> 14 | B3 << 2) & 8191), b4 = i4[7] + ((B3 >>> 11 | A4 << 5) & 8191), I3 = i4[8] + ((A4 >>> 8 | T2 << 8) & 8191), R4 = i4[9] + (T2 >>> 5 | o2), x3 = 0, C5 = x3 + S4 * c5 + L3 * (5 * d3) + U4 * (5 * p3) + _2 * (5 * E6) + j3 * (5 * y7);
    x3 = C5 >>> 13, C5 &= 8191, C5 += g * (5 * h5) + w2 * (5 * f7) + b4 * (5 * l5) + I3 * (5 * u4) + R4 * (5 * a2), x3 += C5 >>> 13, C5 &= 8191;
    let P4 = x3 + S4 * a2 + L3 * c5 + U4 * (5 * d3) + _2 * (5 * p3) + j3 * (5 * E6);
    x3 = P4 >>> 13, P4 &= 8191, P4 += g * (5 * y7) + w2 * (5 * h5) + b4 * (5 * f7) + I3 * (5 * l5) + R4 * (5 * u4), x3 += P4 >>> 13, P4 &= 8191;
    let k6 = x3 + S4 * u4 + L3 * a2 + U4 * c5 + _2 * (5 * d3) + j3 * (5 * p3);
    x3 = k6 >>> 13, k6 &= 8191, k6 += g * (5 * E6) + w2 * (5 * y7) + b4 * (5 * h5) + I3 * (5 * f7) + R4 * (5 * l5), x3 += k6 >>> 13, k6 &= 8191;
    let M4 = x3 + S4 * l5 + L3 * u4 + U4 * a2 + _2 * c5 + j3 * (5 * d3);
    x3 = M4 >>> 13, M4 &= 8191, M4 += g * (5 * p3) + w2 * (5 * E6) + b4 * (5 * y7) + I3 * (5 * h5) + R4 * (5 * f7), x3 += M4 >>> 13, M4 &= 8191;
    let D3 = x3 + S4 * f7 + L3 * l5 + U4 * u4 + _2 * a2 + j3 * c5;
    x3 = D3 >>> 13, D3 &= 8191, D3 += g * (5 * d3) + w2 * (5 * p3) + b4 * (5 * E6) + I3 * (5 * y7) + R4 * (5 * h5), x3 += D3 >>> 13, D3 &= 8191;
    let z3 = x3 + S4 * h5 + L3 * f7 + U4 * l5 + _2 * u4 + j3 * a2;
    x3 = z3 >>> 13, z3 &= 8191, z3 += g * c5 + w2 * (5 * d3) + b4 * (5 * p3) + I3 * (5 * E6) + R4 * (5 * y7), x3 += z3 >>> 13, z3 &= 8191;
    let Z2 = x3 + S4 * y7 + L3 * h5 + U4 * f7 + _2 * l5 + j3 * u4;
    x3 = Z2 >>> 13, Z2 &= 8191, Z2 += g * a2 + w2 * c5 + b4 * (5 * d3) + I3 * (5 * p3) + R4 * (5 * E6), x3 += Z2 >>> 13, Z2 &= 8191;
    let st2 = x3 + S4 * E6 + L3 * y7 + U4 * h5 + _2 * f7 + j3 * l5;
    x3 = st2 >>> 13, st2 &= 8191, st2 += g * u4 + w2 * a2 + b4 * c5 + I3 * (5 * d3) + R4 * (5 * p3), x3 += st2 >>> 13, st2 &= 8191;
    let W3 = x3 + S4 * p3 + L3 * E6 + U4 * y7 + _2 * h5 + j3 * f7;
    x3 = W3 >>> 13, W3 &= 8191, W3 += g * l5 + w2 * u4 + b4 * a2 + I3 * c5 + R4 * (5 * d3), x3 += W3 >>> 13, W3 &= 8191;
    let J3 = x3 + S4 * d3 + L3 * p3 + U4 * E6 + _2 * y7 + j3 * h5;
    x3 = J3 >>> 13, J3 &= 8191, J3 += g * f7 + w2 * l5 + b4 * u4 + I3 * a2 + R4 * c5, x3 += J3 >>> 13, J3 &= 8191, x3 = (x3 << 2) + x3 | 0, x3 = x3 + C5 | 0, C5 = x3 & 8191, x3 = x3 >>> 13, P4 += x3, i4[0] = C5, i4[1] = P4, i4[2] = k6, i4[3] = M4, i4[4] = D3, i4[5] = z3, i4[6] = Z2, i4[7] = st2, i4[8] = W3, i4[9] = J3;
  }
  finalize() {
...
function _s(t2, e2, n2, r2, o2, i4 = 20) {
  let s2 = t2[0], c5 = t2[1], a2 = t2[2], u4 = t2[3], l5 = e2[0], f7 = e2[1], h5 = e2[2], y7 = e2[3], E6 = e2[4], p3 = e2[5], d3 = e2[6], v4 = e2[7], m2 = o2, O5 = n2[0], N4 = n2[1], $4 = n2[2], B3 = s2, A4 = c5, T2 = a2, S4 = u4, L3 = l5, U4 = f7, _2 = h5, j3 = y7, g = E6, w2 = p3, b4 = d3, I3 = v4, R4 = m2, x3 = O5, C5 = N4, P4 = $4;
  for (let M4 = 0; M4 < i4; M4 += 2) B3 = B3 + L3 | 0, R4 = V2(R4 ^ B3, 16), g = g + R4 | 0, L3 = V2(L3 ^ g, 12), B3 = B3 + L3 | 0, R4 = V2(R4 ^ B3, 8), g = g + R4 | 0, L3 = V2(L3 ^ g, 7), A4 = A4 + U4 | 0, x3 = V2(x3 ^ A4, 16), w2 = w2 + x3 | 0, U4 = V2(U4 ^ w2, 12), A4 = A4 + U4 | 0, x3 = V2(x3 ^ A4, 8), w2 = w2 + x3 | 0, U4 = V2(U4 ^ w2, 7), T2 = T2 + _2 | 0, C5 = V2(C5 ^ T2, 16), b4 = b4 + C5 | 0, _2 = V2(_2 ^ b4, 12), T2 = T2 + _2 | 0, C5 = V2(C5 ^ T2, 8), b4 = b4 + C5 | 0, _2 = V2(_2 ^ b4, 7), S4 = S4 + j3 | 0, P4 = V2(P4 ^ S4, 16), I3 = I3 + P4 | 0, j3 = V2(j3 ^ I3, 12), S4 = S4 + j3 | 0, P4 = V2(P4 ^ S4, 8), I3 = I3 + P4 | 0, j3 = V2(j3 ^ I3, 7), B3 = B3 + U4 | 0, P4 = V2(P4 ^ B3, 16), b4 = b4 + P4 | 0, U4 = V2(U4 ^ b4, 12), B3 = B3 + U4 | 0, P4 = V2(P4 ^ B3, 8), b4 = b4 + P4 | 0, U4 = V2(U4 ^ b4, 7), A4 = A4 + _2 | 0, R4 = V2(R4 ^ A4, 16), I3 = I3 + R4 | 0, _2 = V2(_2 ^ I3, 12), A4 = A4 + _2 | 0, R4 = V2(R4 ^ A4, 8), I3 = I3 + R4 | 0, _2 = V2(_2 ^ I3, 7), T2 = T2 + j3 | 0, x3 = V2(x3 ^ T2, 16), g = g + x3 | 0, j3 = V2(j3 ^ g, 12), T2 = T2 + j3 | 0, x3 = V2(x3 ^ T2, 8), g = g + x3 | 0, j3 = V2(j3 ^ g, 7), S4 = S4 + L3 | 0, C5 = V2(C5 ^ S4, 16), w2 = w2 + C5 | 0, L3 = V2(L3 ^ w2, 12), S4 = S4 + L3 | 0, C5 = V2(C5 ^ S4, 8), w2 = w2 + C5 | 0, L3 = V2(L3 ^ w2, 7);
  let k6 = 0;
  r2[k6++] = s2 + B3 | 0, r2[k6++] = c5 + A4 | 0, r2[k6++] = a2 + T2 | 0, r2[k6++] = u4 + S4 | 0, r2[k6++] = l5 + L3 | 0, r2[k6++] = f7 + U4 | 0, r2[k6++] = h5 + _2 | 0, r2[k6++] = y7 + j3 | 0, r2[k6++] = E6 + g | 0, r2[k6++] = p3 + w2 | 0, r2[k6++] = d3 + b4 | 0, r2[k6++] = v4 + I3 | 0, r2[k6++] = m2 + R4 | 0, r2[k6++] = O5 + x3 | 0, r2[k6++] = N4 + C5 | 0, r2[k6++] = $4 + P4 | 0;
}
...
function ks(t2, e2, n2, r2 = 32) {
  ...
  n2 === void 0 && (n2 = jr);
  const i4 = new Uint8Array(o2 * t2.outputLen), s2 = ye.create(t2, e2), c5 = s2._cloneInto(), a2 = new Uint8Array(s2.outputLen);
  for (let u4 = 0; u4 < o2; u4++) Ge[0] = u4 + 1, c5.update(u4 === 0 ? jr : a2).update(n2).update(Ge).digestInto(a2), i4.set(a2, t2.outputLen * u4), s2._cloneInto(c5);
  return s2.destroy(), c5.destroy(), a2.fill(0), Ge.fill(0), i4.slice(0, r2);
}
...
var qs = class extends ke {
  ...
  digestInto(e2) {
    ...
    const c5 = Pe(e2), a2 = this.outputLen;
    ...
    for (let f7 = 0; f7 < u4; f7++) c5.setUint32(4 * f7, l5[f7], i4);
  }
  digest() {
    const { buffer: e2, outputLen: n2 } = this;
    this.digestInto(e2);
...
var Fs = class extends qs {
  ...
  process(e2, n2) {
    ...
    for (let f7 = 16; f7 < 64; f7++) {
      const h5 = bt[f7 - 15], y7 = bt[f7 - 2], E6 = ct(h5, 7) ^ ct(h5, 18) ^ h5 >>> 3, p3 = ct(y7, 17) ^ ct(y7, 19) ^ y7 >>> 10;
      bt[f7] = p3 + bt[f7 - 7] + E6 + bt[f7 - 16] | 0;
    }
    let { A: r2, B: o2, C: i4, D: s2, E: c5, F: a2, G: u4, H: l5 } = this;
    for (let f7 = 0; f7 < 64; f7++) {
      const h5 = ct(c5, 6) ^ ct(c5, 11) ^ ct(c5, 25), y7 = l5 + h5 + Ds(c5, a2, u4) + Ks[f7] + bt[f7] | 0, p3 = (ct(r2, 2) ^ ct(r2, 13) ^ ct(r2, 22)) + Hs(r2, o2, i4) | 0;
      l5 = u4, u4 = a2, a2 = c5, c5 = s2 + y7 | 0, s2 = i4, i4 = o2, o2 = r2, r2 = y7 + p3 | 0;
    }
    r2 = r2 + this.A | 0, o2 = o2 + this.B | 0, i4 = i4 + this.C | 0, s2 = s2 + this.D | 0, c5 = c5 + this.E | 0, a2 = a2 + this.F | 0, u4 = u4 + this.G | 0, l5 = l5 + this.H | 0, this.set(r2, o2, i4, s2, c5, a2, u4, l5);
  }
  roundClean() {
    bt.fill(0);
  }
...
function rc(t2) {
  ...
  return function(c5, a2) {
    ...
    let u4 = r2, l5 = c5.pow(c5.mul(c5.ONE, o2), n2), f7 = c5.pow(a2, i4), h5 = c5.pow(a2, n2);
    for (; !c5.eql(h5, c5.ONE); ) {
      if (c5.eql(h5, c5.ZERO)) return c5.ZERO;
      let y7 = 1;
      for (let p3 = c5.sqr(h5); y7 < u4 && !c5.eql(p3, c5.ONE); y7++) p3 = c5.sqr(p3);
      const E6 = c5.pow(l5, H << BigInt(u4 - y7 - 1));
      l5 = c5.sqr(E6), f7 = c5.mul(f7, E6), h5 = c5.mul(h5, l5), u4 = y7;
    }
    return f7;
  };
}
...
function Kr2(t2, e2, n2 = false, r2 = {}) {
  ...
  let s2;
  const c5 = Object.freeze({ ORDER: t2, isLE: n2, BITS: o2, BYTES: i4, MASK: Je(o2), ZERO: q, ONE: H, create: (a2) => X(a2, t2), isValid: (a2) => {
    if (typeof a2 != "bigint") throw new Error("invalid field element: expected bigint, got " + typeof a2);
    return q <= a2 && a2 < t2;
  }, is0: (a2) => a2 === q, isOdd: (a2) => (a2 & H) === H, neg: (a2) => X(-a2, t2), eql: (a2, u4) => a2 === u4, sqr: (a2) => X(a2 * a2, t2), add: (a2, u4) => X(a2 + u4, t2), sub: (a2, u4) => X(a2 - u4, t2), mul: (a2, u4) => X(a2 * u4, t2), pow: (a2, u4) => cc(c5, a2, u4), div: (a2, u4) => X(a2 * nn(u4, t2), t2), sqrN: (a2) => a2 * a2, addN: (a2, u4) => a2 + u4, subN: (a2, u4) => a2 - u4, mulN: (a2, u4) => a2 * u4, inv: (a2) => nn(a2, t2), sqrt: r2.sqrt || ((a2) => (s2 || (s2 = oc(t2)), s2(c5, a2))), invertBatch: (a2) => ac(c5, a2), cmov: (a2, u4, l5) => l5 ? u4 : a2, toBytes: (a2) => n2 ? be(a2, i4) : Mt(a2, i4), fromBytes: (a2) => {
...
function uc(t2, e2, n2 = false) {
  ...
  const s2 = n2 ? ee(t2) : Ot(t2), c5 = X(s2, e2 - H) + H;
  return n2 ? be(c5, o2) : Mt(c5, o2);
}
var Zr = BigInt(0);
var ve = BigInt(1);
function rn(t2, e2) {
...
function dc(t2, e2) {
  return { constTimeNegate: rn, hasPrecomputes(n2) {
    ...
    for (let u4 = 0; u4 < o2; u4++) {
      a2 = c5, s2.push(a2);
      for (let l5 = 1; l5 < i4; l5++) a2 = a2.add(c5), s2.push(a2);
      c5 = a2.double();
    }
    return s2;
  }, wNAF(n2, r2, o2) {
    ...
    const u4 = BigInt(2 ** n2 - 1), l5 = 2 ** n2, f7 = BigInt(n2);
    for (let h5 = 0; h5 < i4; h5++) {
      const y7 = h5 * s2;
      let E6 = Number(o2 & u4);
      o2 >>= f7, E6 > s2 && (E6 -= l5, o2 += ve);
      const p3 = y7, d3 = y7 + Math.abs(E6) - 1, v4 = h5 % 2 !== 0, m2 = E6 < 0;
      E6 === 0 ? a2 = a2.add(rn(v4, r2[p3])) : c5 = c5.add(rn(m2, r2[d3]));
    }
    return { p: c5, f: a2 };
  }, wNAFUnsafe(n2, r2, o2, i4 = t2.ZERO) {
    const { windows: s2, windowSize: c5 } = on(n2, e2), a2 = BigInt(2 ** n2 - 1), u4 = 2 ** n2, l5 = BigInt(n2);
    for (let f7 = 0; f7 < s2; f7++) {
      const h5 = f7 * c5;
      if (o2 === Zr) break;
      let y7 = Number(o2 & a2);
      if (o2 >>= l5, y7 > c5 && (y7 -= u4, o2 += ve), y7 === 0) continue;
...
function hc(t2, e2, n2, r2) {
  ...
  for (let f7 = u4; f7 >= 0; f7 -= s2) {
    ...
    for (let y7 = 0; y7 < r2.length; y7++) {
      const E6 = r2[y7], p3 = Number(E6 >> BigInt(f7) & BigInt(c5));
      a2[p3] = a2[p3].add(n2[y7]);
    }
    let h5 = o2;
    for (let y7 = a2.length - 1, E6 = o2; y7 > 0; y7--) E6 = E6.add(a2[y7]), h5 = h5.add(E6);
    if (l5 = l5.add(h5), f7 !== 0) for (let y7 = 0; y7 < s2; y7++) l5 = l5.double();
  }
  return l5;
}
function Wr(t2) {
...
function gc(t2) {
  ...
  function f7(m2, O5) {
    ...
    for (let j3 = BigInt(o2 - 1); j3 >= Ht; j3--) {
      ...
      const w2 = B3 + A4, b4 = r2(w2 * w2), I3 = B3 - A4, R4 = r2(I3 * I3), x3 = b4 - R4, C5 = T2 + S4, P4 = T2 - S4, k6 = r2(P4 * w2), M4 = r2(C5 * I3), D3 = k6 + M4, z3 = k6 - M4;
      T2 = r2(D3 * D3), S4 = r2($4 * r2(z3 * z3)), B3 = r2(b4 * R4), A4 = r2(x3 * (b4 + r2(l5 * x3)));
    }
  ...
  function p3(m2, O5) {
    const N4 = y7(O5), $4 = E6(m2), B3 = f7(N4, $4);
  ...
  return { scalarMult: p3, scalarMultBase: v4, getSharedSecret: (m2, O5) => p3(m2, O5), getPublicKey: (m2) => v4(m2), utils: { randomPrivateKey: () => e2.randomBytes(e2.nByteLength) }, GuBytes: d3 };
}
...
BigInt(8);
function bc(t2) {
  const e2 = BigInt(10), n2 = BigInt(20), r2 = BigInt(40), o2 = BigInt(80), i4 = un, c5 = t2 * t2 % i4 * t2 % i4, a2 = it(c5, Xr, i4) * c5 % i4, u4 = it(a2, yc, i4) * t2 % i4, l5 = it(u4, wc, i4) * u4 % i4, f7 = it(l5, e2, i4) * l5 % i4, h5 = it(f7, n2, i4) * f7 % i4, y7 = it(h5, r2, i4) * h5 % i4, E6 = it(y7, o2, i4) * y7 % i4, p3 = it(E6, o2, i4) * y7 % i4, d3 = it(p3, e2, i4) * l5 % i4;
  return { pow_p_5_8: it(d3, Xr, i4) * t2 % i4, b2: c5 };
}
function Ec(t2) {
...
var lt = { Err: Oc, _tlv: { encode: (t2, e2) => {
  ...
  const { v: c5, l: a2 } = r2.decode(2, i4), { v: u4, l: l5 } = r2.decode(2, a2);
...
function Ac(t2) {
  ...
  function s2(p3) {
    const { a: d3, b: v4 } = e2, m2 = n2.sqr(p3), O5 = n2.mul(m2, p3);
  ...
  class h5 {
    ...
    add(d3) {
      ...
      let I3 = n2.add(N4, B3);
      return b4 = n2.mul(b4, I3), I3 = n2.add(_2, g), b4 = n2.sub(b4, I3), I3 = n2.add(m2, O5), A4 = n2.add($4, B3), I3 = n2.mul(I3, A4), A4 = n2.add(j3, g), I3 = n2.sub(I3, A4), S4 = n2.mul(L3, b4), A4 = n2.mul(U4, g), S4 = n2.add(A4, S4), A4 = n2.sub(j3, S4), S4 = n2.add(j3, S4), T2 = n2.mul(A4, S4), j3 = n2.add(_2, _2), j3 = n2.add(j3, _2), g = n2.mul(L3, g), b4 = n2.mul(U4, b4), j3 = n2.add(j3, g), g = n2.sub(_2, g), g = n2.mul(L3, g), b4 = n2.add(b4, g), _2 = n2.mul(j3, b4), T2 = n2.add(T2, _2), _2 = n2.mul(I3, b4), A4 = n2.mul(w2, A4), A4 = n2.sub(A4, _2), _2 = n2.mul(w2, j3), S4 = n2.mul(I3, S4), S4 = n2.add(S4, _2), new h5(A4, T2, S4);
    }
    subtract(d3) {
    ...
    multiplyUnsafe(d3) {
      ...
      return N4 && (T2 = T2.negate()), B3 && (S4 = S4.negate()), S4 = new h5(n2.mul(S4.px, v4.beta), S4.py, S4.pz), T2.add(S4);
    }
    multiply(d3) {
      const { endo: v4, n: m2 } = e2;
      ft("scalar", d3, K2, m2);
      ...
      if (v4) {
        ...
        S4 = E6.constTimeNegate($4, S4), U4 = E6.constTimeNegate(A4, U4), U4 = new h5(n2.mul(U4.px, v4.beta), U4.py, U4.pz), O5 = S4.add(U4), N4 = L3.add(_2);
      } else {
    ...
    multiplyAndAddUnsafe(d3, v4, m2) {
      const O5 = h5.BASE, N4 = (B3, A4) => A4 === dt || A4 === K2 || !B3.equals(O5) ? B3.multiplyUnsafe(A4) : B3.multiply(A4), $4 = N4(this, v4).add(N4(d3, m2));
...
function Ic(t2) {
  ...
  const { ProjectivePoint: a2, normPrivateKeyToScalar: u4, weierstrassEquation: l5, isWithinCurveOrder: f7 } = Ac({ ...e2, toBytes(g, w2, b4) {
  ...
  class d3 {
    ...
    recoverPublicKey(w2) {
      ...
      const P4 = (R4 & 1) === 0 ? "02" : "03", k6 = a2.fromHex(P4 + h5(C5)), M4 = c5(C5), D3 = s2(-x3 * M4), z3 = s2(I3 * M4), Z2 = a2.BASE.multiplyAndAddUnsafe(k6, D3, z3);
  ...
  function S4(g, w2, b4 = L3) {
    ...
    let { lowS: x3, prehash: C5, extraEntropy: P4 } = b4;
    x3 == null && (x3 = true), g = et("msgHash", g), Jr(b4), C5 && (g = et("prehashed msgHash", I3(g)));
    const k6 = B3(g), M4 = u4(w2), D3 = [T2(M4), T2(k6)];
    if (P4 != null && P4 !== false) {
    ...
    function st2(W3) {
      const J3 = $4(W3);
      if (!f7(J3)) return;
      const Be4 = c5(J3), zt3 = a2.BASE.multiply(J3).toAffine(), vt2 = s2(zt3.x);
      if (vt2 === dt) return;
  ...
  function _2(g, w2, b4 = L3) {
    const { seed: I3, k2sig: R4 } = S4(g, w2, b4), x3 = e2;
  ...
  function j3(g, w2, b4, I3 = U4) {
    ...
    const k6 = typeof R4 == "string" || St(R4), M4 = !k6 && !P4 && typeof R4 == "object" && R4 !== null && typeof R4.r == "bigint" && typeof R4.s == "bigint";
    ...
    try {
      if (M4 && (D3 = new d3(R4.r, R4.s)), k6) {
        try {
          P4 !== "compact" && (D3 = d3.fromDER(R4));
        } catch (Ut3) {
          if (!(Ut3 instanceof lt.Err)) throw Ut3;
        }
        !D3 && P4 !== "der" && (D3 = d3.fromCompact(R4));
      }
      z3 = a2.fromHex(b4);
    } catch {
      return false;
    ...
    C5 && (w2 = e2.hash(w2));
    const { r: Z2, s: st2 } = D3, W3 = B3(w2), J3 = c5(st2), Be4 = s2(W3 * J3), zt3 = s2(Z2 * J3), vt2 = (_a = a2.BASE.multiplyAndAddUnsafe(z3, Be4, zt3)) == null ? void 0 : _a.toAffine();
    return vt2 ? s2(vt2.x) === Z2 : false;
  }
  return { CURVE: e2, getPublicKey: m2, getSharedSecret: N4, sign: _2, verify: j3, ProjectivePoint: a2, Signature: d3, utils: v4 };
}
function Nc(t2) {
...
function Se(t2) {
  ...
  if (Bt(r2) === Ft) {
    const a2 = o2 + hn, u4 = a2 + oe, l5 = n2.slice(o2, a2), f7 = n2.slice(a2, u4), h5 = n2.slice(u4);
    return { type: r2, sealed: h5, iv: f7, senderPublicKey: l5 };
  }
  if (Bt(r2) === re) {
    const a2 = n2.slice(o2), u4 = Lt(oe);
    return { type: r2, sealed: a2, iv: u4 };
  }
  const i4 = o2 + oe, s2 = n2.slice(o2, i4), c5 = n2.slice(i4);
...
function zc(t2, e2) {
  ...
  const s2 = i4.slice(0, 32), c5 = i4.slice(32, 64), a2 = `${n2}.${r2}`, u4 = Qt(a2), l5 = io(e2);
  if (!_c.verify(concat([s2, c5]), u4, l5)) throw new Error("Invalid signature");
...
function ie(t2) {
  ...
  for (const [i4, s2] of Object.entries(t2)) {
    const c5 = yn(i4) ? [i4] : s2.chains, a2 = s2.methods || [], u4 = s2.events || [], l5 = yo(i4);
    o2[l5] = oa(ra({}, o2[l5]), { chains: ot(c5, (e2 = o2[l5]) == null ? void 0 : e2.chains), methods: ot(a2, (n2 = o2[l5]) == null ? void 0 : n2.methods), events: ot(u4, (r2 = o2[l5]) == null ? void 0 : r2.events) });
  }
  return o2;
}
function mo(t2) {
...
function aa(t2, e2) {
  var n2, r2, o2, i4, s2, c5;
  const a2 = ie(t2), u4 = ie(e2), l5 = {}, f7 = Object.keys(a2).concat(Object.keys(u4));
  for (const h5 of f7) l5[h5] = { chains: ot((n2 = a2[h5]) == null ? void 0 : n2.chains, (r2 = u4[h5]) == null ? void 0 : r2.chains), methods: ot((o2 = a2[h5]) == null ? void 0 : o2.methods, (i4 = u4[h5]) == null ? void 0 : i4.methods), events: ot((s2 = a2[h5]) == null ? void 0 : s2.events, (c5 = u4[h5]) == null ? void 0 : c5.events) };
  return l5;
}
...
function ua(t2, e2) {
  ...
  return gt(o2, r2) ? (r2.forEach((s2) => {
    const { accounts: c5, methods: a2, events: u4 } = t2.namespaces[s2], l5 = It(c5), f7 = n2[s2];
    (!gt(ue(s2, f7), l5) || !gt(f7.methods, a2) || !gt(f7.events, u4)) && (i4 = false);
  }), i4) : false;
}
function ce(t2) {
...
function No(t2, e2, n2) {
  let r2 = null;
  const o2 = Aa(t2), i4 = Ba(e2), s2 = Object.keys(o2), c5 = Object.keys(i4), a2 = Uo(Object.keys(t2)), u4 = Uo(Object.keys(e2)), l5 = a2.filter((f7) => !u4.includes(f7));
  return l5.length && (r2 = ht("NON_CONFORMING_NAMESPACES", `${n2} namespaces keys don't satisfy requiredNamespaces.
...
function rr2(r2, e2) {
  ...
  var a2 = r2.length, c5 = r2.charAt(0), h5 = Math.log(a2) / Math.log(256), l5 = Math.log(256) / Math.log(a2);
  function d3(u4) {
    ...
    for (var j3 = (D3 - I3) * l5 + 1 >>> 0, T2 = new Uint8Array(j3); I3 !== D3; ) {
      for (var q3 = u4[I3], J3 = 0, K4 = j3 - 1; (q3 !== 0 || J3 < x3) && K4 !== -1; K4--, J3++) q3 += 256 * T2[K4] >>> 0, T2[K4] = q3 % a2 >>> 0, q3 = q3 / a2 >>> 0;
      if (q3 !== 0) throw new Error("Non-zero carry");
      x3 = J3, I3++;
    }
    for (var H3 = j3 - x3; H3 !== j3 && T2[H3] === 0; ) H3++;
    for (var me4 = c5.repeat(b4); H3 < j3; ++H3) me4 += r2.charAt(T2[H3]);
    return me4;
  }
  function g(u4) {
    ...
    if (u4[b4] !== " ") {
      ...
      for (var D3 = (u4.length - b4) * h5 + 1 >>> 0, j3 = new Uint8Array(D3); u4[b4]; ) {
...
var vi2 = class {
  constructor(e2, t2, i4) {
    this.core = e2, this.logger = t2, S2(this, "name", Tt2), S2(this, "keychain"), S2(this, "randomSessionIdentifier", jc()), S2(this, "initialized", false), S2(this, "init", async () => {
      ...
      return Vc({ type: l5, symKey: h5, message: c5, senderPublicKey: d3, encoding: o2 == null ? void 0 : o2.encoding });
...
var _i2 = class extends y4 {
  constructor(e2, t2) {
    super(e2, t2), this.logger = e2, this.core = t2, k4(this, "messages", /* @__PURE__ */ new Map()), k4(this, "messagesWithoutClientAck", /* @__PURE__ */ new Map()), k4(this, "name", Ot2), k4(this, "version", Rt2), k4(this, "initialized", false), k4(this, "storagePrefix", B), k4(this, "init", async () => {
      if (!this.initialized) {
      ...
      if (a2[o2] = s2, this.messages.set(i4, a2), n2 === le2.inbound) {
        ...
        this.messagesWithoutClientAck.set(i4, Un(jn2({}, c5), { [o2]: s2 }));
      }
...
var qn = class extends m {
  constructor(e2, t2) {
    super(e2, t2), this.relayer = e2, this.logger = t2, V3(this, "events", new import_events3.EventEmitter()), V3(this, "name", At2), V3(this, "queue", /* @__PURE__ */ new Map()), V3(this, "publishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_MINUTE)), V3(this, "initialPublishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15)), V3(this, "needsTransportRestart", false), V3(this, "publish", async (i4, s2, n2) => {
      ...
      const a2 = (n2 == null ? void 0 : n2.ttl) || je2, c5 = Zc(n2), h5 = (n2 == null ? void 0 : n2.prompt) || false, l5 = (n2 == null ? void 0 : n2.tag) || 0, d3 = (n2 == null ? void 0 : n2.id) || getBigIntRpcId().toString(), g = { topic: i4, message: s2, opts: { ttl: a2, relay: c5, prompt: h5, tag: l5, id: d3, attestation: n2 == null ? void 0 : n2.attestation, tvf: n2 == null ? void 0 : n2.tvf } }, _2 = `Failed to publish payload, please try again. id:${d3} tag:${l5}`;
      try {
        const u4 = new Promise(async (b4) => {
          ...
          const I3 = yi(new Promise((D3, j3) => {
            this.rpcPublish({ topic: i4, message: s2, ttl: a2, prompt: h5, tag: l5, id: d3, attestation: n2 == null ? void 0 : n2.attestation, tvf: n2 == null ? void 0 : n2.tvf }).then(D3).catch((T2) => {
        ...
        this.logger.trace({ type: "method", method: "publish", params: { id: d3, topic: i4, message: s2, opts: n2 } }), await yi(u4, this.publishTimeout, _2);
      } catch (u4) {
  ...
  async rpcPublish(e2) {
    var t2, i4, s2, n2;
    const { topic: o2, message: a2, ttl: c5 = je2, prompt: h5, tag: l5, id: d3, attestation: g, tvf: _2 } = e2, u4 = { method: Yc(Zc().protocol).publish, params: Ie2({ topic: o2, message: a2, ttl: c5, prompt: h5, tag: l5, attestation: g }, _2), id: d3 };
  ...
  async rpcSubscribe(e2, t2, i4) {
    ...
    try {
      ...
      if ((i4 == null ? void 0 : i4.transportType) === Q.link_mode) return setTimeout(() => {
        (this.relayer.connected || this.relayer.connecting) && this.relayer.request(n2).catch((l5) => this.logger.warn(l5));
      }, (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND)), a2;
      const c5 = new Promise(async (l5) => {
        const d3 = (g) => {
          g.topic === e2 && (this.events.removeListener($.created, d3), l5(g.id));
        };
        this.events.on($.created, d3);
        try {
          const g = await yi(new Promise((_2, u4) => {
...
var Si2 = class extends d {
  ...
  async subscribe(e2, t2) {
    ...
    const h5 = (l5) => {
      l5.topic === e2 && (this.subscriber.off($.created, h5), c5());
    };
    return await Promise.all([new Promise((l5) => {
      c5 = l5, this.subscriber.on($.created, h5);
  ...
  try {
    switch (s2) {
      ...
      case uo2: {
        ...
        for (let l5 = 0; l5 < c5.length; l5++) {
          const d3 = c5[l5], g = h5.findIndex((_2) => pe2(d3, _2, void 0, r2, e2, t2, i4));
          if (g === -1) return false;
          h5.splice(g, 1);
        }
        return true;
      ...
      case Je2: {
        ...
        for (let d3 = 0; d3 < h5.length; d3++) {
          const g = h5[d3], _2 = r2[g];
          if (!Object.hasOwn(e2, g)) return false;
          const u4 = e2[g];
          if (!pe2(_2, u4, g, r2, e2, t2, i4)) return false;
        }
        return true;
      }
      default:
...
var zi2 = class extends f4 {
  constructor(e2, t2, i4, s2 = B, n2 = void 0) {
    ...
    }), z2(this, "get", (o2) => (this.isInitialized(), this.logger.debug("Getting value"), this.logger.trace({ type: "method", method: "get", key: o2 }), this.getData(o2))), z2(this, "getAll", (o2) => (this.isInitialized(), o2 ? this.values.filter((a2) => Object.keys(o2).every((c5) => Ao2(a2[c5], o2[c5]))) : this.values)), z2(this, "update", async (o2, a2) => {
...
var Li2 = class {
  constructor(e2, t2) {
    this.core = e2, this.logger = t2, p2(this, "name", Mt2), p2(this, "version", Kt2), p2(this, "events", new import_events3.default()), p2(this, "pairings"), p2(this, "initialized", false), p2(this, "storagePrefix", B), p2(this, "ignoredPayloadTypes", [Ft]), p2(this, "registeredMethods", []), p2(this, "init", async () => {
      ...
      return this.events.emit(re2.create, c5), this.core.expirer.set(n2, o2), await this.pairings.set(n2, c5), await this.core.relayer.subscribe(n2, { transportType: i4 == null ? void 0 : i4.transportType }), { topic: n2, uri: h5 };
      ...
      if (this.pairings.keys.includes(n2)) {
        if (l5 = this.pairings.get(n2), s2.addTrace(G2.existing_pairing), l5.active) throw s2.setError(Y2.active_pairing_already_exists), new Error(`Pairing already exists: ${n2}. Please try again with a new connection URI.`);
        s2.addTrace(G2.pairing_not_expired);
      }
      const d3 = c5 || Ei(import_time2.FIVE_MINUTES), g = { topic: n2, relay: a2, expiry: d3, active: false, methods: h5 };
      ...
      const o2 = formatJsonRpcRequest(s2, n2), a2 = await this.core.crypto.encode(i4, o2), c5 = se2[s2].req;
      return this.core.history.set(i4, o2), this.core.relayer.publish(i4, a2, c5), o2.id;
    }), p2(this, "sendResult", async (i4, s2, n2) => {
      const o2 = formatJsonRpcResult(i4, n2), a2 = await this.core.crypto.encode(s2, o2), c5 = (await this.core.history.get(s2, i4)).request.method, h5 = se2[c5].res;
      await this.core.relayer.publish(s2, a2, h5), await this.core.history.resolve(o2);
    }), p2(this, "sendError", async (i4, s2, n2) => {
      const o2 = formatJsonRpcError(i4, n2), a2 = await this.core.crypto.encode(s2, o2), c5 = (await this.core.history.get(s2, i4)).request.method, h5 = se2[c5] ? se2[c5].res : se2.unregistered_method.res;
      await this.core.relayer.publish(s2, a2, h5), await this.core.history.resolve(o2);
...
var ki2 = class extends I {
  constructor(e2, t2) {
    ...
    }), O3(this, "get", async (i4, s2) => (this.isInitialized(), this.logger.debug("Getting record"), this.logger.trace({ type: "method", method: "get", topic: i4, id: s2 }), await this.getRecord(s2))), O3(this, "delete", (i4, s2) => {
    ...
    }), O3(this, "exists", async (i4, s2) => (this.isInitialized(), this.records.has(s2) ? (await this.getRecord(s2)).topic === i4 : false)), O3(this, "on", (i4, s2) => {
      this.events.on(i4, s2);
    }), O3(this, "once", (i4, s2) => {
      this.events.once(i4, s2);
    }), O3(this, "off", (i4, s2) => {
      this.events.off(i4, s2);
    }), O3(this, "removeListener", (i4, s2) => {
      this.events.removeListener(i4, s2);
...
var Ui2 = class extends M {
  constructor(e2, t2, i4) {
    super(e2, t2, i4), this.core = e2, this.logger = t2, this.store = i4, w(this, "name", Wt2), w(this, "abortController"), w(this, "isDevEnv"), w(this, "verifyUrlV3", Yt2), w(this, "storagePrefix", B), w(this, "version", Le), w(this, "publicKey"), w(this, "fetchPromise"), w(this, "init", async () => {
      ...
      try {
        const h5 = (0, import_window_getters2.getDocument)(), l5 = this.startAbortTimer(import_time2.ONE_SECOND * 5), d3 = await new Promise((g, _2) => {
          const u4 = () => {
            window.removeEventListener("message", x3), h5.body.removeChild(b4), _2("attestation aborted");
          };
          ...
          const x3 = (I3) => {
            if (I3.data && typeof I3.data == "string") try {
              ...
              if (D3.type === "verify_attestation") {
                ...
                clearInterval(l5), h5.body.removeChild(b4), this.abortController.signal.removeEventListener("abort", u4), window.removeEventListener("message", x3), g(D3.attestation === null ? "" : D3.attestation);
              }
            } catch (D3) {
              this.logger.warn(D3);
            }
...
var Bi2 = class extends R {
  constructor(e2, t2, i4 = true) {
    super(e2, t2, i4), this.core = e2, this.logger = t2, E3(this, "context", ei2), E3(this, "storagePrefix", B), E3(this, "storageVersion", Qt2), E3(this, "events", /* @__PURE__ */ new Map()), E3(this, "shouldPersist", false), E3(this, "init", async () => {
      ...
      const { event: n2 = "ERROR", type: o2 = "", properties: { topic: a2, trace: c5 } } = s2, h5 = Bi(), l5 = this.core.projectId || "", d3 = Date.now(), g = be2({ eventId: h5, timestamp: d3, props: { event: n2, type: o2, properties: { topic: a2, trace: c5 } }, bundleId: l5, domain: this.getAppDomain() }, this.setMethods(h5));
...
var Te = class _Te extends h3 {
  constructor(e2) {
    ...
    super(e2), v2(this, "protocol", ze2), v2(this, "version", Le), v2(this, "name", he2), v2(this, "relayUrl"), v2(this, "projectId"), v2(this, "customStoragePrefix"), v2(this, "events", new import_events3.EventEmitter()), v2(this, "logger"), v2(this, "heartbeat"), v2(this, "relayer"), v2(this, "crypto"), v2(this, "storage"), v2(this, "history"), v2(this, "expirer"), v2(this, "pairing"), v2(this, "verify"), v2(this, "echoClient"), v2(this, "linkModeSupportedApps"), v2(this, "eventClient"), v2(this, "initialized", false), v2(this, "logChunkController"), v2(this, "on", (a2, c5) => this.events.on(a2, c5)), v2(this, "once", (a2, c5) => this.events.once(a2, c5)), v2(this, "off", (a2, c5) => this.events.off(a2, c5)), v2(this, "removeListener", (a2, c5) => this.events.removeListener(a2, c5)), v2(this, "dispatchEnvelope", ({ topic: a2, message: c5, sessionExists: h5 }) => {
      if (!a2 || !c5) return;
      const l5 = { topic: a2, message: c5, publishedAt: Date.now(), transportType: Q.link_mode };
...
var c4 = (S4, n2, e2) => Ue2(S4, typeof n2 != "symbol" ? n2 + "" : n2, e2);
var Ns2 = class extends V {
  constructor(n2) {
    super(n2), c4(this, "name", dt2), c4(this, "events", new import_events4.default()), c4(this, "initialized", false), c4(this, "requestQueue", { state: $2.idle, queue: [] }), c4(this, "sessionRequestQueue", { state: $2.idle, queue: [] }), c4(this, "requestQueueDelay", import_time3.ONE_SECOND), c4(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), c4(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), c4(this, "recentlyDeletedLimit", 200), c4(this, "relayMessageCache", []), c4(this, "pendingSessions", /* @__PURE__ */ new Map()), c4(this, "init", async () => {
      ...
      const d3 = await this.client.core.crypto.generateKeyPair(), w2 = N2.wc_sessionPropose.req.ttl || import_time3.FIVE_MINUTES, m2 = Ei(w2), f7 = b2(v3(v3({ requiredNamespaces: i4, optionalNamespaces: r2, relays: l5 ?? [{ protocol: xt2 }], proposer: { publicKey: d3, metadata: this.client.metadata }, expiryTimestamp: m2, pairingTopic: p3 }, o2 && { sessionProperties: o2 }), a2 && { scopedProperties: a2 }), { id: payloadId() }), _2 = xi("session_connect", f7.id), { reject: g, resolve: A4, done: D3 } = gi(w2, $e2), I3 = ({ id: T2 }) => {
        T2 === f7.id && (this.client.events.off("proposal_expire", I3), this.pendingSessions.delete(f7.id), this.events.emit(_2, { error: { message: $e2, code: 0 } }));
      };
      ...
      }), await this.sendRequest({ topic: p3, method: "wc_sessionPropose", params: f7, throwOnFailedPublish: true, clientRpcId: f7.id }), await this.setProposal(f7.id, f7), { uri: h5, approval: D3 };
      ...
      const { pairingTopic: w2, proposer: m2, requiredNamespaces: f7, optionalNamespaces: _2 } = d3;
      ...
      const A4 = await this.client.core.crypto.generateKeyPair(), D3 = m2.publicKey, I3 = await this.client.core.crypto.generateSharedKey(A4, D3), T2 = v3(v3(v3({ relay: { protocol: a2 ?? "irn" }, namespaces: l5, controller: { publicKey: A4, metadata: this.client.metadata }, expiry: Ei(J2) }, p3 && { sessionProperties: p3 }), h5 && { scopedProperties: h5 }), u4 && { sessionConfig: u4 }), K4 = Q.relay;
      ...
      const fe3 = b2(v3({}, T2), { topic: I3, requiredNamespaces: f7, optionalNamespaces: _2, pairingTopic: w2, acknowledged: false, self: T2.controller, peer: { publicKey: m2.publicKey, metadata: m2.metadata }, controller: A4, transportType: Q.relay });
      ...
      const { topic: t2, namespaces: s2 } = e2, { done: i4, resolve: r2, reject: o2 } = gi(), a2 = payloadId(), l5 = getBigIntRpcId().toString(), p3 = this.client.session.get(t2).namespaces;
      ...
      const a2 = payloadId(), l5 = getBigIntRpcId().toString(), { done: p3, resolve: h5, reject: u4 } = gi(r2, "Request expired. Please try again.");
      ...
      if (w2) return await this.sendRequest({ clientRpcId: a2, relayRpcId: l5, topic: i4, method: d3, params: { request: b2(v3({}, s2), { expiryTimestamp: Ei(r2) }), chainId: t2 }, expiry: r2, throwOnFailedPublish: true, appLink: w2 }).catch((_2) => u4(_2)), this.client.events.emit("session_request_sent", { topic: i4, request: s2, chainId: t2, id: a2 }), await p3();
      ...
      return await Promise.all([new Promise(async (_2) => {
        await this.sendRequest(v3({ clientRpcId: a2, relayRpcId: l5, topic: i4, method: d3, params: m2, expiry: r2, throwOnFailedPublish: true }, f7 && { tvf: this.getTVFParams(a2, m2) })).catch((g) => u4(g)), this.client.events.emit("session_request_sent", { topic: i4, request: s2, chainId: t2, id: a2 }), _2();
      ...
      if (this.client.session.keys.includes(t2)) {
        ...
        this.events.once(xi("session_ping", s2), ({ error: l5 }) => {
          l5 ? a2(l5) : o2();
    ...
    }), c4(this, "find", (e2) => (this.isInitialized(), this.client.session.getAll().filter((t2) => ua(t2, e2)))), c4(this, "getPendingSessionRequests", () => this.client.pendingRequest.getAll()), c4(this, "authenticate", async (e2, t2) => {
      var s2;
      ...
      const { chains: o2, statement: a2 = "", uri: l5, domain: p3, nonce: h5, type: u4, exp: d3, nbf: w2, methods: m2 = [], expiry: f7 } = e2, _2 = [...e2.resources || []], { topic: g, uri: A4 } = await this.client.core.pairing.create({ methods: ["wc_sessionAuthenticate"], transportType: r2 });
      ...
      try {
        if (i4) {
          ...
          Ie4 = Xc(t2, g, L3);
        } else await Promise.all([this.sendRequest({ topic: g, method: "wc_sessionAuthenticate", params: K4, expiry: e2.expiry, throwOnFailedPublish: true, clientRpcId: te3 }), this.sendRequest({ topic: g, method: "wc_sessionPropose", params: q3, expiry: N2.wc_sessionPropose.req.ttl, throwOnFailedPublish: true, clientRpcId: q3.id })]);
      } catch (x3) {
      ...
      const a2 = r2.requester.publicKey, l5 = await this.client.core.crypto.generateKeyPair(), p3 = Pc(a2), h5 = { type: Ft, receiverPublicKey: a2, senderPublicKey: l5 }, u4 = [], d3 = [];
      for (const f7 of s2) {
        ...
        const { p: _2 } = f7, g = pe(_2.resources), A4 = [dr(_2.iss)], D3 = De(_2.iss);
        if (g) {
      ...
      if ((u4 == null ? void 0 : u4.length) > 0) {
        m2 = { topic: w2, acknowledged: true, self: { publicKey: l5, metadata: this.client.metadata }, peer: { publicKey: a2, metadata: r2.requester.metadata }, controller: a2, expiry: Ei(J2), authentication: s2, requiredNamespaces: {}, optionalNamespaces: {}, relay: { protocol: "irn" }, pairingTopic: r2.pairingTopic, namespaces: ca([...new Set(u4)], [...new Set(d3)]), transportType: o2 }, i4.addTrace(ir2.subscribing_authenticated_session_topic);
        try {
      ...
      const r2 = i4.requester.publicKey, o2 = await this.client.core.crypto.generateKeyPair(), a2 = Pc(r2), l5 = { type: Ft, receiverPublicKey: r2, senderPublicKey: o2 };
      await this.sendError({ id: t2, topic: a2, error: s2, encodeOpts: l5, rpcOpts: N2.wc_sessionAuthenticate.reject, appLink: this.getAppLinkIfEnabled(i4.requester.metadata, i4.transportType) }), await this.client.auth.requests.delete(t2, { message: "rejected", code: 0 }), await this.client.proposal.delete(t2, Nt("USER_DISCONNECTED"));
      ...
      await this.client.core.relayer.unsubscribe(s2), await this.client.session.delete(s2, Nt("USER_DISCONNECTED")), this.addToRecentlyDeleted(s2, "session"), this.client.core.crypto.keychain.has(a2.publicKey) && await this.client.core.crypto.deleteKeyPair(a2.publicKey), this.client.core.crypto.keychain.has(s2) && await this.client.core.crypto.deleteSymKey(s2), i4 || this.client.core.expirer.del(s2), this.client.core.storage.removeItem(Me3).catch((l5) => this.client.logger.warn(l5)), this.getPendingSessionRequests().forEach((l5) => {
        l5.topic === s2 && this.deletePendingSessionRequest(l5.id, Nt("USER_DISCONNECTED"));
      ...
      if (f7.attestation = m2, r2 && (f7.ttl = r2), o2 && (f7.id = o2), this.client.core.history.set(t2, u4), w2) {
        const _2 = Xc(p3, t2, d3);
        await global.Linking.openURL(_2, this.client.name);
      } else {
        const _2 = N2[s2].req;
        r2 && (_2.ttl = r2), o2 && (_2.id = o2), _2.tvf = b2(v3({}, h5), { correlationId: u4.id }), l5 ? (_2.internal = b2(v3({}, _2.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(t2, d3, _2)) : this.client.core.relayer.publish(t2, d3, _2).catch((g) => this.client.logger.error(g));
      }
      return u4.id;
      ...
      if (h5) {
        ...
        const w2 = u4.request.method, m2 = N2[w2].res;
      ...
      if (h5) {
        ...
        const d3 = u4.request.method, w2 = o2 || N2[d3].res;
      ...
      try {
        ...
        const p3 = o2.expiryTimestamp || Ei(N2.wc_sessionPropose.req.ttl), h5 = v3({ id: a2, pairingTopic: t2, expiryTimestamp: p3 }, o2);
        ...
        await this.sendError({ id: a2, topic: t2, error: l5, rpcOpts: N2.wc_sessionPropose.autoReject }), this.client.logger.error(l5);
      }
      ...
      try {
        ...
        const { relay: r2, controller: o2, expiry: a2, namespaces: l5, sessionProperties: p3, scopedProperties: h5, sessionConfig: u4 } = t2.params, d3 = [...this.pendingSessions.values()].find((f7) => f7.sessionTopic === e2);
      ...
      try {
        ...
        const d3 = this.client.session.get(r2), w2 = await this.getVerifyContext({ attestationId: a2, hash: kc(JSON.stringify(formatJsonRpcRequest("wc_sessionRequest", u4, h5))), encryptedId: l5, metadata: d3.peer.metadata, transportType: p3 }), m2 = { id: h5, topic: r2, params: u4, verifyContext: w2 };
      ...
      try {
        const { requester: l5, authPayload: p3, expiryTimestamp: h5 } = i4.params, u4 = await this.getVerifyContext({ attestationId: r2, hash: kc(JSON.stringify(i4)), encryptedId: o2, metadata: l5.metadata, transportType: a2 }), d3 = { requester: l5, pairingTopic: s2, id: i4.id, authPayload: p3, verifyContext: u4, expiryTimestamp: h5 };
        ...
        await this.sendError({ id: i4.id, topic: s2, error: l5, encodeOpts: d3, rpcOpts: N2.wc_sessionAuthenticate.autoReject, appLink: u4 });
      }
      ...
      if (!ma(e2)) {
        const { message: l5 } = ht("MISSING_OR_INVALID", `connect() params: ${JSON.stringify(e2)}`);
        throw new Error(l5);
      }
      ...
      if (Et(t2) || await this.isValidPairingTopic(t2), !ga(a2, true)) {
        const { message: l5 } = ht("MISSING_OR_INVALID", `connect() relays: ${a2}`);
        throw new Error(l5);
      }
      if (!Et(s2) && Oe(s2) !== 0) {
      ...
      const a2 = this.client.proposal.get(t2), l5 = Bo(s2, "approve()");
      ...
      if (!ma(e2)) {
        const { message: l5 } = ht("MISSING_OR_INVALID", `onSessionSettleRequest() params: ${e2}`);
        throw new Error(l5);
      }
      const { relay: t2, controller: s2, namespaces: i4, expiry: r2 } = e2;
      if (!Io(t2)) {
        const { message: l5 } = ht("MISSING_OR_INVALID", "onSessionSettleRequest() relay protocol should be a string");
        throw new Error(l5);
      }
      ...
      if (vi(r2)) {
        const { message: l5 } = ht("EXPIRED", "onSessionSettleRequest()");
        throw new Error(l5);
      }
...
var E4 = (S4, n2, e2) => Ms2(S4, typeof n2 != "symbol" ? n2 + "" : n2, e2);
var Ee3 = class _Ee extends J {
  constructor(n2) {
    super(n2), E4(this, "protocol", De2), E4(this, "version", Le2), E4(this, "name", me2.name), E4(this, "metadata"), E4(this, "core"), E4(this, "logger"), E4(this, "events", new import_events4.EventEmitter()), E4(this, "engine"), E4(this, "session"), E4(this, "proposal"), E4(this, "pendingRequest"), E4(this, "auth"), E4(this, "signConfig"), E4(this, "on", (t2, s2) => this.events.on(t2, s2)), E4(this, "once", (t2, s2) => this.events.once(t2, s2)), E4(this, "off", (t2, s2) => this.events.off(t2, s2)), E4(this, "removeListener", (t2, s2) => this.events.removeListener(t2, s2)), E4(this, "removeAllListeners", (t2) => this.events.removeAllListeners(t2)), E4(this, "connect", async (t2) => {
      try {
...
function $3(s2, t2, e2, i4 = /* @__PURE__ */ new Map(), n2 = void 0) {
  ...
  if (Array.isArray(s2)) {
    ...
    i4.set(s2, r2);
    for (let c5 = 0; c5 < s2.length; c5++) r2[c5] = $3(s2[c5], c5, e2, i4, n2);
  ...
  if (s2 instanceof Map) {
    ...
    i4.set(s2, r2);
    for (const [c5, o2] of s2) r2.set(c5, $3(o2, c5, e2, i4, n2));
    return r2;
  }
  if (s2 instanceof Set) {
    const r2 = /* @__PURE__ */ new Set();
    i4.set(s2, r2);
    for (const c5 of s2) r2.add($3(c5, void 0, e2, i4, n2));
    return r2;
  }
  ...
  if (s2 instanceof DataView) {
    ...
    return i4.set(s2, r2), y6(r2, s2, e2, i4, n2), r2;
  }
  ...
  if (s2 instanceof Error) {
    ...
    return i4.set(s2, r2), r2.message = s2.message, r2.name = s2.name, r2.stack = s2.stack, r2.cause = s2.cause, y6(r2, s2, e2, i4, n2), r2;
  }
...
function se3(s2, t2) {
  return te2(s2, (e2, i4, n2, a2) => {
    ...
    if (typeof s2 == "object") switch (Object.prototype.toString.call(s2)) {
      ...
      case ht3: {
        const c5 = {};
        return y6(c5, s2), c5.length = s2.length, c5[Symbol.iterator] = s2[Symbol.iterator], c5;
      }
      default:
        return;
    }
...
function F3(s2, t2, e2, i4) {
  if (k5(s2) && (s2 = Object(s2)), t2 == null || typeof t2 != "object") return s2;
  ...
  for (let a2 = 0; a2 < n2.length; a2++) {
    ...
    if (dt3(c5) && (c5 = { ...c5 }), dt3(o2) && (o2 = { ...o2 }), typeof Buffer < "u" && Buffer.isBuffer(c5) && (c5 = pt3(c5)), Array.isArray(c5)) if (typeof o2 == "object" && o2 != null) {
    ...
    const m2 = e2(o2, c5, r2, s2, t2, i4);
    m2 != null ? s2[r2] = m2 : Array.isArray(c5) || it3(o2) && it3(c5) ? s2[r2] = F3(o2, c5, e2, i4) : o2 == null && re3(c5) ? s2[r2] = F3({}, c5, e2, i4) : o2 == null && ie3(c5) ? s2[r2] = pt3(c5) : (o2 === void 0 || c5 !== void 0) && (s2[r2] = c5);
  }
  return s2;
}
function ae3(s2, ...t2) {
...
function mt3(s2) {
  ...
  const r2 = {};
  if (!Oe(s2)) return r2;
  for (const [c5, o2] of Object.entries(s2)) {
    const m2 = yn(c5) ? [c5] : o2.chains, w2 = o2.methods || [], v4 = o2.events || [], P4 = o2.rpcMap || {}, p3 = yo(c5);
...
function gt3(s2) {
  ...
  for (const [e2, i4] of Object.entries(s2)) {
    const n2 = i4.methods || [], a2 = i4.events || [], r2 = i4.accounts || [], c5 = yn(e2) ? [e2] : i4.chains ? i4.chains : ft3(i4.accounts);
...
var O4 = (s2, t2, e2) => me3(s2, typeof t2 != "symbol" ? t2 + "" : t2, e2);
var ve2 = class {
  constructor(t2) {
    O4(this, "name", "polkadot"), O4(this, "client"), O4(this, "httpProviders"), O4(this, "events"), O4(this, "namespace"), O4(this, "chainId"), this.namespace = t2.namespace, this.events = h4("events"), this.client = h4("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders();
  }
  updateNamespace(t2) {
...
var Ie3 = class {
  ...
  async getCapabilities(t2) {
    var e2, i4, n2, a2, r2;
    const c5 = (i4 = (e2 = t2.request) == null ? void 0 : e2.params) == null ? void 0 : i4[0], o2 = ((a2 = (n2 = t2.request) == null ? void 0 : n2.params) == null ? void 0 : a2[1]) || [], m2 = `${c5}${o2.join(",")}`;
...
var E5 = (s2, t2, e2) => Se3(s2, typeof t2 != "symbol" ? t2 + "" : t2, e2);
var De3 = class {
  constructor(t2) {
    E5(this, "name", "algorand"), E5(this, "client"), E5(this, "httpProviders"), E5(this, "events"), E5(this, "namespace"), E5(this, "chainId"), this.namespace = t2.namespace, this.events = h4("events"), this.client = h4("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders();
  }
  updateNamespace(t2) {
    this.namespace = Object.assign(this.namespace, t2);
  }
...
var N3 = (s2, t2, e2) => je3(s2, typeof t2 != "symbol" ? t2 + "" : t2, e2);
var Re = class {
  constructor(t2) {
    N3(this, "name", "cip34"), N3(this, "client"), N3(this, "httpProviders"), N3(this, "events"), N3(this, "namespace"), N3(this, "chainId"), this.namespace = t2.namespace, this.events = h4("events"), this.client = h4("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders();
  }
  updateNamespace(t2) {
    this.namespace = Object.assign(this.namespace, t2);
  }
...
var D2 = (s2, t2, e2) => Me4(s2, typeof t2 != "symbol" ? t2 + "" : t2, e2);
var xe2 = class {
  constructor(t2) {
    D2(this, "name", "multiversx"), D2(this, "client"), D2(this, "httpProviders"), D2(this, "events"), D2(this, "namespace"), D2(this, "chainId"), this.namespace = t2.namespace, this.events = h4("events"), this.client = h4("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders();
  }
  updateNamespace(t2) {
    this.namespace = Object.assign(this.namespace, t2);
  }
...
var j2 = (s2, t2, e2) => ke4(s2, typeof t2 != "symbol" ? t2 + "" : t2, e2);
var We4 = class {
  constructor(t2) {
    j2(this, "name", "tezos"), j2(this, "client"), j2(this, "httpProviders"), j2(this, "events"), j2(this, "namespace"), j2(this, "chainId"), this.namespace = t2.namespace, this.events = h4("events"), this.client = h4("client"), this.chainId = this.getDefaultChain(), this.httpProviders = this.createHttpProviders();
  }
  updateNamespace(t2) {
    this.namespace = Object.assign(this.namespace, t2);
  }
...
var l4 = (s2, t2, e2) => Y3(s2, typeof t2 != "symbol" ? t2 + "" : t2, e2);
var B2 = class _B {
  constructor(t2) {
    l4(this, "client"), l4(this, "namespaces"), l4(this, "optionalNamespaces"), l4(this, "sessionProperties"), l4(this, "scopedProperties"), l4(this, "events", new import_events5.default()), l4(this, "rpcProviders", {}), l4(this, "session"), l4(this, "providerOpts"), l4(this, "logger"), l4(this, "uri"), l4(this, "disableProviderPing", false), this.providerOpts = t2, this.logger = typeof (t2 == null ? void 0 : t2.logger) < "u" && typeof (t2 == null ? void 0 : t2.logger) != "string" ? t2.logger : (0, import_pino.default)(k({ level: (t2 == null ? void 0 : t2.logger) || et2 })), this.disableProviderPing = (t2 == null ? void 0 : t2.disableProviderPing) || false;
  }
  ...
  async request(t2, e2, i4) {
    ...
    return await this.getProvider(n2).request({ request: x2({}, t2), chainId: `${n2}:${a2}`, topic: this.session.topic, expiry: i4 });
  }
  ...
  createProviders() {
    ...
    V4("client", this.client), V4("events", this.events), V4("disableProviderPing", this.disableProviderPing), t2.forEach((e2) => {
      if (!this.session) return;
      const i4 = le3(e2, this.session), n2 = ft3(i4), a2 = M3(this.namespaces, this.optionalNamespaces), r2 = Q2(x2({}, a2[e2]), { accounts: i4, chains: n2 });
      switch (e2) {
        case "eip155":
  ...
  registerEventListeners() {
    ...
    this.client.on("session_ping", (t2) => {
      ...
      if (a2.name === "accountsChanged") {
        ...
        const r2 = i4.chainId, c5 = i4.event.data, o2 = yo(r2), m2 = K3(r2) !== K3(c5) ? `${o2}:${K3(c5)}` : r2;
      ...
      this.session = Q2(x2({}, r2), { namespaces: a2 }), this.onSessionUpdate(), this.events.emit("session_update", { topic: t2, params: e2 });
    }), this.client.on("session_delete", async (t2) => {
      var e2;
      t2.topic === ((e2 = this.session) == null ? void 0 : e2.topic) && (await this.cleanup(), this.events.emit("session_delete", t2), this.events.emit("disconnect", Q2(x2({}, Nt("USER_DISCONNECTED")), { data: t2.topic })));
  ...
  emitAccountsChangedOnChainChange({ namespace: t2, previousChainId: e2, newChainId: i4 }) {
    ...
    try {
      ...
      if (!r2) return;
      const c5 = r2.filter((o2) => o2.includes(`${i4}:`)).map(vt);
      if (!se(c5)) return;
...
*/
//# sourceMappingURL=chunk-XTDWLL5Y.js.map
