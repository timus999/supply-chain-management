import {
  require_buffer
} from "./chunk-ZWHEUTLK.js";
import {
  createRef,
  ref,
  require_browser
} from "./chunk-DUVUG2MV.js";
import {
  classMap,
  ifDefined,
  property,
  state
} from "./chunk-2BM4G4ZR.js";
import {
  A,
  E,
  k
...
var require_dayjs_min = __commonJS({
  "node_modules/@web3modal/common/node_modules/dayjs/dayjs.min.js"(exports, module) {
    !function(t2, e2) {
      ...
      "use strict";
      var t2 = 1e3, e2 = 6e4, n = 36e5, r = "millisecond", i = "second", s2 = "minute", u = "hour", a = "day", o = "week", c2 = "month", f = "quarter", h2 = "year", d = "date", l2 = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y2 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t3) {
        ...
        return { M: c2, y: h2, w: o, d: a, D: d, h: u, m: s2, s: i, ms: r, Q: f }[t3] || String(t3 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t3) {
        return void 0 === t3;
      } }, g = "en", D = {};
      D[g] = M;
      ...
      var _ = function() {
        ...
        return m2.parse = function(t3) {
          ...
          var n2, o2 = b.p(t3), f2 = "set" + (this.$u ? "UTC" : ""), l3 = (n2 = {}, n2[a] = f2 + "Date", n2[d] = f2 + "Date", n2[c2] = f2 + "Month", n2[h2] = f2 + "FullYear", n2[u] = f2 + "Hours", n2[s2] = f2 + "Minutes", n2[i] = f2 + "Seconds", n2[r] = f2 + "Milliseconds", n2)[o2], $2 = o2 === a ? this.$D + (e3 - this.$W) : e3;
          if (o2 === c2 || o2 === h2) {
          ...
          var r2 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i2 = b.z(this), s3 = this.$H, u2 = this.$m, a2 = this.$M, o2 = n2.weekdays, c3 = n2.months, f2 = n2.meridiem, h3 = function(t4, n3, i3, s4) {
      ...
      return O.prototype = k2, [["$ms", r], ["$s", i], ["$m", s2], ["$H", u], ["$W", a], ["$M", c2], ["$y", h2], ["$D", d]].forEach(function(t3) {
        k2[t3[1]] = function(e3) {
  ...
  "node_modules/@web3modal/common/node_modules/dayjs/plugin/relativeTime.js"(exports, module) {
    !function(r, e2) {
      ...
      return function(r, e2, t2) {
        ...
        t2.en.relativeTime = o, n.fromToBase = function(e3, n2, i2, d2, u) {
          for (var f, a, s2, l2 = i2.$locale().relativeTime || o, h2 = r.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], m = h2.length, c2 = 0; c2 < m; c2 += 1) {
            var y2 = h2[c2];
            y2.d && (f = d2 ? t2(e3).diff(i2, y2.d, true) : i2.diff(e3, y2.d, true));
            var p = (r.rounding || Math.round)(Math.abs(f));
            if (s2 = f > 0, p <= y2.r || !y2.r) {
              p <= 1 && c2 > 0 && (y2 = h2[c2 - 1]);
              var v = l2[y2.l];
              u && (p = u("" + p)), a = "string" == typeof v ? v.replace("%d", p) : v(p, n2, y2.l, s2);
              break;
            }
          }
          if (n2) return a;
...
function clone(configObject) {
  ...
  BigNumber2.random = function() {
    ...
    return function(dp) {
      var a, b, e2, k2, v, i = 0, c2 = [], rand = new BigNumber2(ONE);
  ...
  convertBase = /* @__PURE__ */ function() {
    ...
    return function(str, baseIn, baseOut, sign, callerIsToString) {
      var alphabet, d, e2, k2, r, x, xc, y2, i = str.indexOf("."), dp = DECIMAL_PLACES, rm = ROUNDING_MODE;
      if (i >= 0) {
        k2 = POW_PRECISION;
        POW_PRECISION = 0;
        str = str.replace(".", "");
  ...
  function maxOrMin(args, n) {
    var k2, y2, i = 1, x = new BigNumber2(args[0]);
    for (; i < args.length; i++) {
      y2 = new BigNumber2(args[i]);
      if (!y2.s || (k2 = compare(x, y2)) === n || k2 === 0 && x.s === n) {
        x = y2;
      }
    }
    return x;
  ...
  P.exponentiatedBy = P.pow = function(n, m) {
    ...
    return m ? y2.mod(m) : k2 ? round(y2, POW_PRECISION, ROUNDING_MODE, more) : y2;
  };
  ...
  P.multipliedBy = P.times = function(y2, b) {
    var c2, e2, i, j, k2, m, xcL, xlo, xhi, ycL, ylo, yhi, zc, base, sqrtBase, x = this, xc = x.c, yc = (y2 = new BigNumber2(y2, b)).c;
    if (!xc || !yc || !xc[0] || !yc[0]) {
  ...
  P.toFraction = function(md) {
    var d, d0, d1, d2, e2, exp, n, n0, n1, q, r, s2, x = this, xc = x.c;
    if (md != null) {
      n = new BigNumber2(md);
...
function compare(x, y2) {
  var a, b, xc = x.c, yc = y2.c, i = x.s, j = y2.s, k2 = x.e, l2 = y2.e;
  if (!i || !j) return null;
  a = xc && !xc[0];
  b = yc && !yc[0];
...
var WuiOtp = class WuiOtp2 extends LitElement {
  ...
  getInputElement(el) {
    var _a2;
    if ((_a2 = el.shadowRoot) == null ? void 0 : _a2.querySelector("input")) {
...
var WuiTokenListItem = class WuiTokenListItem2 extends LitElement {
  ...
  render() {
    ...
    const value = this.amount && this.price ? (_a2 = NumberUtil.multiply(this.price, this.amount)) == null ? void 0 : _a2.toFixed(3) : null;
    return html`
      <wui-flex alignItems="center">
        ${this.visualTemplate()}
        <wui-flex flexDirection="column" gap="3xs">
...
var WuiListAccordion = class WuiListAccordion2 extends LitElement {
  ...
  checkHeight() {
    this.updateComplete.then(() => {
      ...
      const textElement = (_b = this.shadowRoot) == null ? void 0 : _b.querySelector(".textContent");
...
var ChainController = {
  ...
  subscribeChainProp(property2, callback) {
    ...
    return subscribe(state7.chains, () => {
      ...
      const activeChain = state7.activeChain;
      if (activeChain) {
        const nextValue = (_a2 = state7.chains.get(activeChain)) == null ? void 0 : _a2[property2];
        if (prev !== nextValue) {
          prev = nextValue;
          callback(nextValue);
        }
  ...
  setChainNetworkData(chain, props, replaceState = false) {
    ...
    if (chainAdapter) {
      ...
      state7.chains.set(chain, ref2(chainAdapter));
  ...
  setActiveChain(chain) {
    ...
    if (newAdapter && newAdapter.chain !== state7.activeChain) {
      ...
      state7.activeCaipNetwork = ((_a2 = newAdapter.networkState) == null ? void 0 : _a2.caipNetwork) ? ref2((_b = newAdapter.networkState) == null ? void 0 : _b.caipNetwork) : void 0;
  ...
  setActiveCaipNetwork(caipNetwork) {
    ...
    state7.activeCaipNetwork = ref2(caipNetwork);
  ...
  setActiveConnector(connector) {
    if (connector) {
      state7.activeConnector = ref2(connector);
    }
  },
...
var NetworkController = {
  ...
  replaceState(newState) {
    ...
    Object.assign(state8, ref2(newState));
  },
  ...
  checkIfSmartAccountEnabled() {
    var _a2;
    const networkId = NetworkUtil.caipNetworkIdToNumber((_a2 = state8.caipNetwork) == null ? void 0 : _a2.id);
...
var SwapController = {
  ...
  getParams() {
    ...
    const invalidToToken = !((_a2 = state16.toToken) == null ? void 0 : _a2.address) || !((_b = state16.toToken) == null ? void 0 : _b.decimals);
  ...
  resetValues() {
    ...
    const networkToken = (_a2 = state16.tokens) == null ? void 0 : _a2.find((token) => token.address === networkAddress);
  ...
  async sendTransactionForSwap(data) {
    ...
    const snackbarPendingMessage = `Swapping ${(_a2 = state16.sourceToken) == null ? void 0 : _a2.symbol} to ${NumberUtil.formatNumberToLocalString(toTokenAmount, 3)} ${(_b = state16.toToken) == null ? void 0 : _b.symbol}`;
...
var AccountController = {
  ...
  replaceState(newState) {
    ...
    Object.assign(state17, ref2(newState));
  },
  subscribe(callback) {
...
var WuiProfileButtonV2 = class WuiProfileButtonV22 extends LitElement {
  ...
  handleClick(event) {
    ...
    if (event.target instanceof HTMLElement && event.target.id === "copy-address") {
      (_a2 = this.onCopyClick) == null ? void 0 : _a2.call(this, event);
      return;
    }
...
var WuiListAccount = class WuiListAccount2 extends LitElement {
  ...
  connectedCallback() {
    ...
    BlockchainApiController.getBalance(this.accountAddress, (_a2 = this.caipNetwork) == null ? void 0 : _a2.id).then((response) => {
  ...
  getLabel() {
    var _a2;
    let label = (_a2 = this.labels) == null ? void 0 : _a2.get(this.accountAddress);
...
var TransactionUtil = {
  ...
  getTransactionImageURL(transfer) {
    ...
    if (transfer && isNFT) {
      imageURL = (_c = (_b = (_a2 = transfer == null ? void 0 : transfer.nft_info) == null ? void 0 : _a2.content) == null ? void 0 : _b.preview) == null ? void 0 : _c.url;
...
//# sourceMappingURL=chunk-A7OMPQGV.js.map
