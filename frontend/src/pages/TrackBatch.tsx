...
export const TrackBatch: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchBatchData = async () => {
      ...
      const mockData = {
        id: batchId,
        product: batchId === 'MED001' ? 'Pain Relief Cream' : 
        ...
        timeline: [
          {
            ...
            status: 'completed',
            details: 'Aloe Vera Extract - 500kg harvested and quality verified',
            icon: Package
          },
          {
          ...
          },
          {
            ...
            status: 'completed',
            details: 'Manufactured 1000 units with batch testing completed',
            icon: Factory
          },
          {
            ...
            status: 'completed',
            details: 'Quality verification and inventory update completed',
            icon: Building2
          },
          {
            ...
            status: 'completed',
            details: 'Distributed to certified pharmacy network',
            icon: Store
          },
          {
            ...
            status: 'completed',
            details: 'Final quality check passed - Available for dispensing',
            icon: Hospital
          }
        ]
      };
